 ...
 * 
 */
@WebServiceClient(name = "HelloWorldImplService", targetNamespace = "http://myPackage.ex.com/", wsdlLocation = "http://localhost:9999/ws/hello?wsdl")
    ...
    extends Service
{
    ...
    private final static QName HELLOWORLDIMPLSERVICE_QNAME = new QName("http://myPackage.ex.com/", "HelloWorldImplService");
    ...
    public HelloWorld getHelloWorldImplPort() {
        return super.getPort(new QName("http://myPackage.ex.com/", "HelloWorldImplPort"), HelloWorld.class);
    }
    ...
    public HelloWorld getHelloWorldImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://myPackage.ex.com/", "HelloWorldImplPort"), HelloWorld.class, features);
    }
